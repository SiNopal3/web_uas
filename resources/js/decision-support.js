...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initComparisonEngine(data) {
        ...
        // Set default values (empty state initially or check defaults)
        selectA.value = '';
        selectB.value = '';
        searchA.value = '';
        searchB.value = '';
    ...
    function renderComparisonEngine(data, nameA, nameB) {
        ...
        if (!nameA && !nameB) {
            tbody.innerHTML = `
                <tr style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06);">
                    <td class="py-2 px-3 rounded-start border-start border-primary border-4">
                        <div class="fw-bold text-white d-flex align-items-center mb-0" style="font-size: 13px;">GDP &amp; Pertumbuhan</div>
                        <span class="badge bg-primary-subtle text-primary border border-primary" style="font-size: 10px;">Economic Scale</span>
                    </td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-end py-2 px-3 rounded-end"><span class="badge bg-dark border border-secondary text-muted p-1" style="font-size: 11px;">Pilih 2 Negara</span></td>
                </tr>
                <tr style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06);">
                    <td class="py-2 px-3 rounded-start border-start border-danger border-4">
                        <div class="fw-bold text-white d-flex align-items-center mb-0" style="font-size: 13px;">Inflasi &amp; Stabilitas Harga</div>
                        <span class="badge bg-danger-subtle text-danger border border-danger" style="font-size: 10px;">Shock Index</span>
                    </td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-end py-2 px-3 rounded-end"><span class="badge bg-dark border border-secondary text-muted p-1" style="font-size: 11px;">Pilih 2 Negara</span></td>
                ...
                <tr style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06);">
                    <td class="py-2 px-3 rounded-start border-start border-warning border-4">
                        <div class="fw-bold text-white d-flex align-items-center mb-0" style="font-size: 13px;">Risiko Rantai Pasok</div>
                        <span class="badge bg-warning-subtle text-warning border border-warning" style="font-size: 10px;">Disruption Index</span>
                    </td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-end py-2 px-3 rounded-end"><span class="badge bg-dark border border-secondary text-muted p-1" style="font-size: 11px;">Pilih 2 Negara</span></td>
                ...
                <tr style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06);">
                    <td class="py-2 px-3 rounded-start border-start border-info border-4">
                        <div class="fw-bold text-white d-flex align-items-center mb-0" style="font-size: 13px;">Cuaca &amp; Pelabuhan</div>
                        <span class="badge bg-info-subtle text-info border border-info" style="font-size: 10px;">Maritime Transit</span>
                    </td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-end py-2 px-3 rounded-end"><span class="badge bg-dark border border-secondary text-muted p-1" style="font-size: 11px;">Pilih 2 Negara</span></td>
                ...
                <tr style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06);">
                    <td class="py-2 px-3 rounded-start border-start border-success border-4">
                        <div class="fw-bold text-white d-flex align-items-center mb-0" style="font-size: 13px;">Mata Uang &amp; Valas</div>
                        <span class="badge bg-success-subtle text-success border border-success" style="font-size: 10px;">FX Volatility</span>
                    </td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-center py-2 px-3"><div class="h6 fw-bold text-muted mb-0">--</div><div class="text-muted" style="font-size: 11px;">Belum dipilih</div></td>
                    <td class="text-end py-2 px-3 rounded-end"><span class="badge bg-dark border border-secondary text-muted p-1" style="font-size: 11px;">Pilih 2 Negara</span></td>
        ...
        tbody.innerHTML = `
            ...
            <tr style="background: rgba(255,255,255,0.025); border: 1px solid rgba(255,255,255,0.08);">
                ...
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-white mb-0">${cA.gdp.value}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-info-subtle text-info border border-info" style="font-size: 10px;">+${cA.gdp.growth} Growth</span>
                        <span class="text-light" style="font-size: 11px; opacity: 0.85;">${cA.gdp.status}</span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-primary" style="width: ${cA.gdp.score}%"></div></div>
                </td>
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-white mb-0">${cB.gdp.value}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-success-subtle text-success border border-success" style="font-size: 10px;">+${cB.gdp.growth} Growth</span>
                        <span class="text-light" style="font-size: 11px; opacity: 0.85;">${cB.gdp.status}</span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-warning" style="width: ${cB.gdp.score}%"></div></div>
                </td>
                <td class="text-end py-2 px-3 rounded-end">
                    <span class="badge bg-${gdpDiff >= 0 ? 'success' : 'warning'}-subtle text-${gdpDiff >= 0 ? 'success' : 'warning'} border border-${gdpDiff >= 0 ? 'success' : 'warning'} px-2 py-1 d-inline-block mb-1" style="font-size: 11px;">${gdpDiff >= 0 ? '+' : ''}${gdpDiff.toFixed(1)}% Growth Spread</span>
                    <div class="text-light fw-bold" style="font-size: 11px;">${gdpDiff >= 0 ? cA.name + ' Pertumbuhan Lebih Tinggi' : cB.name + ' Pertumbuhan Lebih Tinggi'}</div>
                </td>
            </tr>
            ...
            <tr style="background: rgba(255,255,255,0.025); border: 1px solid rgba(255,255,255,0.08);">
                ...
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-danger mb-0">${cA.inflation.rate}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-secondary" style="font-size: 10px;">Risk: ${cA.inflation.score}/100</span>
                        <span class="text-light" style="font-size: 11px; opacity: 0.85;">${cA.inflation.status}</span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-danger" style="width: ${cA.inflation.score}%"></div></div>
                </td>
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-warning mb-0">${cB.inflation.rate}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-secondary" style="font-size: 10px;">Risk: ${cB.inflation.score}/100</span>
                        <span class="text-light" style="font-size: 11px; opacity: 0.85;">${cB.inflation.status}</span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-warning" style="width: ${cB.inflation.score}%"></div></div>
                </td>
                <td class="text-end py-2 px-3 rounded-end">
                    <span class="badge bg-${infDiff <= 0 ? 'success' : 'danger'}-subtle text-${infDiff <= 0 ? 'success' : 'danger'} border border-${infDiff <= 0 ? 'success' : 'danger'} px-2 py-1 d-inline-block mb-1" style="font-size: 11px;">${infDiff > 0 ? '+' : ''}${infDiff.toFixed(1)} Pts Risk Spread</span>
                    <div class="text-light fw-bold" style="font-size: 11px;">${infDiff <= 0 ? cA.name + ' Lebih Stabil' : cB.name + ' Lebih Stabil'}</div>
                </td>
            </tr>
            ...
            <tr style="background: rgba(255,255,255,0.025); border: 1px solid rgba(255,255,255,0.08);">
                ...
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-success mb-0">${cA.risk.score} / 100</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-${cA.risk.badge_color}" style="font-size: 10px;">${cA.risk.level}</span>
                        <span class="text-muted" style="font-size: 11px;">Mar: <strong class="text-white">${cA.risk.maritime}</strong> | Fin: <strong class="text-white">${cA.risk.financial}</strong></span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-success" style="width: ${cA.risk.score}%"></div></div>
                </td>
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-info mb-0">${cB.risk.score} / 100</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-${cB.risk.badge_color}" style="font-size: 10px;">${cB.risk.level}</span>
                        <span class="text-muted" style="font-size: 11px;">Mar: <strong class="text-white">${cB.risk.maritime}</strong> | Fin: <strong class="text-white">${cB.risk.financial}</strong></span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-info" style="width: ${cB.risk.score}%"></div></div>
                </td>
                <td class="text-end py-2 px-3 rounded-end">
                    <span class="badge bg-${riskDiff <= 0 ? 'success' : 'warning'}-subtle text-${riskDiff <= 0 ? 'success' : 'warning'} border border-${riskDiff <= 0 ? 'success' : 'warning'} px-2 py-1 d-inline-block mb-1" style="font-size: 11px;">${riskDiff > 0 ? '+' : ''}${riskDiff.toFixed(1)} Pts Risk Spread</span>
                    <div class="text-light fw-bold" style="font-size: 11px;">${riskDiff <= 0 ? cA.name + ' Risiko Lebih Rendah' : cB.name + ' Risiko Lebih Rendah'}</div>
                </td>
            </tr>
            ...
            <tr style="background: rgba(255,255,255,0.025); border: 1px solid rgba(255,255,255,0.08);">
                ...
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h6 fw-bold text-white mb-0">${cA.weather.condition}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-info-subtle text-info border border-info" style="font-size: 10px;">Score: ${cA.weather.score}/100</span>
                        <span class="text-muted" style="font-size: 11px;">Wind: <strong class="text-white">${cA.weather.wind_speed}</strong></span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-info" style="width: ${cA.weather.score}%"></div></div>
                </td>
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h6 fw-bold text-white mb-0">${cB.weather.condition}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-warning-subtle text-warning border border-warning" style="font-size: 10px;">Score: ${cB.weather.score}/100</span>
                        <span class="text-muted" style="font-size: 11px;">Wind: <strong class="text-white">${cB.weather.wind_speed}</strong></span>
                    </div>
                    <div class="progress mx-auto" style="height: 4px; width: 80%; background: rgba(255,255,255,0.1);"><div class="progress-bar bg-warning" style="width: ${cB.weather.score}%"></div></div>
                </td>
                <td class="text-end py-2 px-3 rounded-end">
                    <span class="badge bg-${weatherDiff <= 0 ? 'success' : 'info'}-subtle text-${weatherDiff <= 0 ? 'success' : 'info'} border border-${weatherDiff <= 0 ? 'success' : 'info'} px-2 py-1 d-inline-block mb-1" style="font-size: 11px;">${weatherDiff > 0 ? '+' : ''}${weatherDiff.toFixed(1)} Pts Weather Spread</span>
                    <div class="text-light fw-bold" style="font-size: 11px;">${weatherDiff <= 0 ? cA.name + ' Cuaca Lebih Tenang' : cB.name + ' Cuaca Lebih Tenang'}</div>
                </td>
            </tr>
            ...
            <tr style="background: rgba(255,255,255,0.025); border: 1px solid rgba(255,255,255,0.08);">
                ...
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-success mb-0">${cA.currency.code.split(' - ')[0]}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-dark border border-secondary text-light" style="font-size: 10px;">Vol Risk: ${cA.currency.score}/100</span>
                        <span class="badge bg-success" style="font-size: 10px;">${cA.currency.trend}</span>
                    </div>
                </td>
                <td class="text-center py-2 px-3 border-end border-secondary" style="border-color: rgba(255,255,255,0.06) !important;">
                    <div class="h5 fw-bold text-info mb-0">${cB.currency.code.split(' - ')[0]}</div>
                    <div class="d-flex justify-content-center align-items-center gap-1 my-1">
                        <span class="badge bg-dark border border-secondary text-light" style="font-size: 10px;">Vol Risk: ${cB.currency.score}/100</span>
                        <span class="badge bg-success" style="font-size: 10px;">${cB.currency.trend}</span>
                    </div>
                </td>
                <td class="text-end py-2 px-3 rounded-end">
                    <span class="badge bg-success-subtle text-success border border-success px-2 py-1 d-inline-block mb-1" style="font-size: 11px;">${curDiff < 6 ? 'Low Spread' : (curDiff < 15 ? 'Moderate Spread' : 'High Differential')}</span>
                    <div class="text-light fw-bold" style="font-size: 11px;">${cA.currency.score <= cB.currency.score ? cA.name + ' FX Lebih Stabil' : cB.name + ' FX Lebih Stabil'}</div>
                </td>
            </tr>
        `;
    }
