...
@section('title', 'Berita Logistik & AI Lexicon Sentiment - RiskIntel Hub')
...
<div class="container-fluid p-0">
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div id="newsCard" class="glass-card h-100 d-flex flex-column">
                <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-3 flex-wrap gap-2" style="border-color: rgba(255,255,255,0.12) !important;">
                    <div>
                        <h5 class="fw-bold text-white mb-1">
                            Feed Berita Terkini & Sentimen Logistik (GNews API Sync)
                        </h5>
                        <div class="small" style="color: #cbd5e1;">Menampilkan artikel analisis internal (Admin) saat belum memilih negara, atau berita logistik global per negara yang dipilih.</div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <span id="newsCountBadge" class="badge bg-dark border border-secondary text-white small px-3 py-2">3 Articles per Country</span>
                    </div>
                </div>
                <div id="newsListContainer" class="row g-4 pt-2">
                    <div class="col-12 text-center small py-5" style="color: #cbd5e1;">
                        <i class="fa-solid fa-spinner fa-spin me-2 text-info"></i> Memuat 3 artikel logistik global terkini...
                    </div>
                </div>
            </div>
        </div>
